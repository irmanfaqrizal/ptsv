...
void if_B_instance::_jitter_3_dispatch(IfMessage* message) {
  if (message != NULL)
    switch(message->getSid()) {
    }
  else {
...
void if_B_instance::_jitter_3_1_fire(IfMessage* X) {
  ...
  if (opt_gen_lineno) ITERATOR->trace(IfEvent::DEBUG, m_pid, "38"); 
...
void if_B_instance::_wait_4_dispatch(IfMessage* message) {
  if (message != NULL)
    switch(message->getSid()) {
    }
  else {
...
void if_B_instance::_wait_4_1_fire(IfMessage* X) {
  ...
  if (opt_gen_lineno) ITERATOR->trace(IfEvent::DEBUG, m_pid, "43"); 
...
inline void if_B_instance::_wait_4_1a_fire() {

  ITERATOR->set(&m_var.x,0,m_pid);
}
inline void if_B_instance::_wait_4_1b_fire() {
