define(`_FILE_', `nondeterministic-stripped')
include(code.m4)
...
code(fire,second_3,2,DELAYABLE,,,(constraint(m_var.y,0,2*((int) 3)+1),{0,0,0}),
	,((a),(b)),c,,,21)
code(action,second_3,2,a,
	set,m_var.y,0)
code(action,second_3,2,b,
	informal,"three")
code(action,second_3,2,c,
	nextstate,(top,-1,top,2,))
