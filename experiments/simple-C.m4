...
code(fire,wait_4,1,EAGER,,,(constraint(m_var.x,0,2*((int) 2)+1),constraint(0,m_var.x,-2*(2)+1),{0,0,0}),
	,((a)),b,,,20)
...
code(start,(),(C),,time)code(priority_rule_begin, 1)
