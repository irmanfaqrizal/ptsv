...
/* 
 * simpler [system] instance interface 
 *
 */

class if_simpler_instance : public IfInstance { 

  public:
    if_simpler_instance(if_pid_type = 0, IfQueue* = IfQueue::NIL);
    if_simpler_instance(const if_simpler_instance&);
...
class if_A_instance : public if_simpler_instance {
...
//         void tpc();
  ...
  inline void _start_1_1b_fire();
         ...
         void _wait_2_dispatch(IfMessage*);

         void _wait_2_1_fire(IfMessage*);
  inline void _wait_2_1a_fire();
  inline void _wait_2_1b_fire();


         void _first_3_dispatch(IfMessage*);

         void _first_3_1_fire(IfMessage*);
  inline void _first_3_1a_fire();
  inline void _first_3_1b_fire();
...
class if_B_instance : public if_simpler_instance {
